...
<Note>
AI functions are experimental. Set [`allow_experimental_ai_functions`](/reference/settings/session-settings/allow-experimental#allow_experimental_ai_functions) to enable them.
</Note>
...
2. otherwise the applicable default-credentials setting:
   - [`ai_function_text_default_credentials`](/reference/settings/session-settings/ai-function#ai_function_text_default_credentials) for the text functions (`aiGenerate`, `aiClassify`, `aiExtract`, `aiTranslate`);
   - [`ai_function_embedding_default_credentials`](/reference/settings/session-settings/ai-function#ai_function_embedding_default_credentials) for `aiEmbed`.
